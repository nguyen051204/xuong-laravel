                    ...
                    <div class="breadcrumb-bg d-flex justify-content-center align-items-center">
                        ...
                        <div class="breadcrumb-content text-center">
                            ...
                            <ul class="page-switcher d-flex ">
                                <li><a href="{{ route('home') }}">Home</a> <i class="flaticon-arrow-pointing-to-right"></i></li>
                                <li>Login</li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row mt-100 justify-content-center">
                <div class="col-xxl-6 col-xl-6 col-lg-8 col-md-10">
                    ...
                    <div class="reg-social-login mt-4">
                        <h5>or login WITH</h5>
                        <ul class="social-login-options">
                            <li><a href="#" class="facebook-login"><i class="flaticon-facebook-app-symbol"></i> Sign up with Facebook</a></li>
                            <li><a href="#" class="google-login"><i class="flaticon-pinterest-1"></i> Sign up with Google</a></li>
                        </ul>
                    </div>
                </div>
            </div>
